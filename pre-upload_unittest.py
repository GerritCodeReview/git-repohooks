...
class PreUploadMainTests(unittest.TestCase):
    ...
    @mock.patch("os.chdir")
    def test_run_project_hooks_yes_propagation(self, _mock_chdir, mock_run_cwd):
        """Verify _run_project_hooks passes yes=True to
        _run_project_hooks_in_cwd.
        """
    ...
    def test_run_project_hooks_in_cwd_yes_propagation(self, mock_config):
        """Verify _run_project_hooks_in_cwd calls
        callable_builtin_hooks(yes=True).
        """
