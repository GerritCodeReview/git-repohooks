...
class BuiltinHooksTests(unittest.TestCase):
    ...
    def _test_commit_message_errors(self, func, desc, expected_errors, files=None):
        ...
        self.assertEqual(
            len(ret),
            len(expected_errors),
            msg=f"Expected {len(expected_errors)} error(s) for {{{desc}}}, got {len(ret)}: {[r.error for r in ret]}",
        )
    ...
    def test_commit_msg_changeid_field_invalid_casing(self, _mock_check, _mock_run):
    ...
    def test_commit_msg_changeid_field_invalid_format(self, _mock_check, _mock_run):
    ...
    def test_commit_msg_changeid_field_valid_and_invalid_casing(self, _mock_check, _mock_run):
        """Verify check_commit_msg_changeid_field catches both invalid casing and duplicate lines."""
        self._test_commit_message_errors(
            rh.hooks.check_commit_msg_changeid_field,
            "subj\n\nChange-Id: I1234\nChange-ID: I5678\n",
    ...
    def test_commit_msg_changeid_field_valid_and_invalid_format(self, _mock_check, _mock_run):
        """Verify check_commit_msg_changeid_field catches both format errors and duplicate lines."""
        self._test_commit_message_errors(
            rh.hooks.check_commit_msg_changeid_field,
            "subj\n\nChange-Id: I1234\nChange-Id: 5678\n",
