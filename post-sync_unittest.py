...
class PostSyncTests(unittest.TestCase):
    ...
    @mock.patch("rh.git.find_repo_root")
    def test_with_repo_topdir(self, mock_find_root):
        """Check that repo_topdir is used and find_repo_root is not called."""
        self.assertEqual(0, post_sync.main(repo_topdir=str(self.repo_root)))
